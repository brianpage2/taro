...
자신의 애착 유형을 이해하면 연애에서 반복되는 패턴의 원인을 파악하고, 더 건강한 관계를 만들어 가는 데 도움이 됩니다.`,
  faqs: [
    ...
    {
      question: '회피형 애착을 가진 사람과 연애하면 어떻게 해야 하나요?',
      answer: '회피형은 감정 표현이 어렵고 거리를 두려는 경향이 있습니다. 충분한 공간을 주면서도 천천히 신뢰를 쌓는 것이 중요합니다. 상호 이해와 소통이 관계 발전의 핵심입니다.',
    },
    {
      question: '불안형 애착의 주요 특징은 무엇인가요?',
      answer: '연인이 자신을 떠날까 봐 지속적으로 불안해하고, 관심과 확인을 자주 요구하며, 연인의 작은 행동에도 민감하게 반응하는 것이 주요 특징입니다. 이는 어린 시절 일관성 없는 돌봄에서 형성되는 경우가 많습니다.',
    },
  ],
  questions: [
    {
