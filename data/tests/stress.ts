...
총점 0~40점이며, 낮을수록 스트레스를 적게 지각함을 의미합니다. 한국 성인 평균은 약 18~22점 수준으로 알려져 있습니다.`,
  ...
  faqs: [
    ...
    {
      question: '스트레스와 번아웃의 차이는 무엇인가요?',
      answer: '스트레스는 과도한 압박에 대한 반응이고, 번아웃은 장기간의 스트레스로 인해 완전히 소진된 상태입니다. 스트레스는 휴식으로 회복 가능하지만, 번아웃은 더 장기적인 회복이 필요합니다.',
    },
    {
      question: '직장 스트레스를 줄이는 방법은 무엇인가요?',
      answer: '업무 우선순위 설정, 적절한 휴식 시간 확보, 동료나 상사와의 원활한 소통, 퇴근 후 완전한 휴식이 중요합니다. 필요하면 직장 내 상담 프로그램을 활용하거나 전문 심리상담을 받으세요.',
    },
  ],
  questions: [
    {
