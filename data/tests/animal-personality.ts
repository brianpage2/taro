...
단순한 오락을 넘어, 자신의 성격 특성을 재미있고 직관적으로 이해하는 계기가 될 수 있습니다. 가족, 친구들과 함께 해보며 결과를 공유해보세요!`,
  faqs: [
    ...
    {
      question: '동물 성격 테스트는 MBTI와 어떤 관련이 있나요?',
      answer: '직접적인 관련은 없지만, 동물 유형과 MBTI 유형 사이에 유사성이 있습니다. 예를 들어 사자형은 ENTJ·ESTJ, 올빼미형은 INTJ·INTP 성향과 유사한 특성을 공유합니다.',
    },
    {
      question: '어떤 동물 유형이 리더십에 가장 적합한가요?',
      answer: '사자(리더십·추진력), 올빼미(전략적 사고·통찰력), 여우(전략·적응력)가 리더십에 강한 유형으로 알려져 있습니다. 하지만 모든 유형은 고유한 리더십 스타일을 가질 수 있습니다.',
    },
  ],
  questions: [
