...
완벽주의 자체는 문제가 아닙니다. 중요한 것은 완벽주의가 자신을 동기부여하는 긍정적 힘인지, 아니면 두려움과 실패 회피에서 비롯된 부정적 힘인지 파악하는 것입니다.`,
  faqs: [
    ...
    {
      question: '완벽주의가 직장 생활에 미치는 영향은 무엇인가요?',
      answer: '적절한 완벽주의는 높은 업무 품질과 성취로 이어질 수 있습니다. 그러나 과도한 완벽주의는 업무 지연, 번아웃, 동료와의 갈등을 유발할 수 있습니다. 완벽주의를 활용하되 균형을 유지하는 것이 중요합니다.',
    },
    {
      question: '완벽주의와 우울증의 관계는 무엇인가요?',
      answer: '지나친 완벽주의는 자기비판과 실패 두려움을 통해 우울증과 불안장애의 위험 요인이 될 수 있습니다. 스스로에게 너무 높은 기준을 세우고 달성하지 못할 때의 좌절이 반복되면 우울감으로 이어질 수 있습니다.',
    },
  ],
  questions: [
    {
